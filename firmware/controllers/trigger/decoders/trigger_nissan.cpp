...
void initializeNissanHRcrank(TriggerWaveform *s) {
    ...
    s->tdcPosition = 210 + 360;

  s->setTriggerSynchronizationGap3(/*gapIndex*/0, 2.25, 5);
  for (size_t i = 1 ; i < count ; i++) {
    s->setTriggerSynchronizationGap3(/*gapIndex*/i, 0.65, 1.5);
  }
...
void initializeNissanHRvvtIn(TriggerWaveform *s) {
	...
	s->addToothFallRise(120);
	s->addToothFallRise(120+17);
	s->addToothFallRise(240);
	s->addToothFallRise(360);

	//s->setTriggerSynchronizationGap(0.15);
   // s->setSecondTriggerSynchronizationGap(6);


	
    s->setTriggerSynchronizationGap3(/*gapIndex*/0, 5, 7);

	for (size_t i = 0 ; i < 2 ; i++) {
    s->setTriggerSynchronizationGap3(/*gapIndex*/i, 0.7, 1.5);
    }

    s->setTriggerSynchronizationGap3(/*gapIndex*/3, 0.05, 0.5);
    ;
...
void initializeNissanHRvvtEx(TriggerWaveform *s) {
	...
	s->addToothRiseFall(120, wide);
	s->addToothRiseFall(240, wide);
	...
	//s->setSecondTriggerSynchronizationGap(0.11);
